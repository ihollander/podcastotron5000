...
class LoginContainer extends React.Component {
  ...
  // window.gapi => script tag in index.html (no npm package)
  componentDidMount() {
    window.gapi.load('client:auth2', () => {
      window.gapi.client.init({
        clientId: '91373925646-aql8oo1t0s807s40nbobeme8hluk9t2b.apps.googleusercontent.com',
        scope: 'email'
      }).then(() => {
  ...
  render() {
    ...
    return isSignedIn
      ...
      : <LoginButton buttonText="Sign In with Google" onButtonClick={this.onSignInClick} />
  }
}
